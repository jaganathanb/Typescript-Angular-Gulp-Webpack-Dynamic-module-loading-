...
/******/ 			script.src = __webpack_require__.p + "" + chunkId + ".module.js";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DashboardController = __webpack_require__(1);
	var LoginController = __webpack_require__(2);
	var AppController = __webpack_require__(3);
	var ModuleProvider = __webpack_require__(4);
	var AuthService = __webpack_require__(5);
	var Base64 = __webpack_require__(6);
	var routes = __webpack_require__(7);
	var MainView = __webpack_require__(20);
...
/***/ function(module, exports) {
	...
	var v1="<div class=\"panel panel-default\"> <div class=\"panel-heading\"> {{vm.title}} </div> <div class=\"panel-body\"> {{vm.message}} </div> </div>";
...
/***/ function(module, exports) {
	...
	var v1="<div class=\"panel panel-default\"> <div class=\"panel-heading\"> {{vm.title}} </div> <div class=\"panel-body\"> <p> A list of our apps: </p> <ul class=\"list\"> <li class=\"list-item\" ng-repeat=\"capt in vm.apps\" ng-bind=\"capt.name\"></li> </ul> </div> </div>";
	window.angular.module(["ng"]).run(["$templateCache",function(c){c.put("list.html", v1)}]);
	module.exports=v1;
...
/***/ function(module, exports) {
	...
	var v1="<div class=\"container\"> <div class=\"row\"> <div class=\"col-sm-6 col-md-4 col-md-offset-4\"> <h1 class=\"text-center login-title\">Login to TAGW</h1> <div class=\"account-wall\"> <img class=\"profile-img\" src=\"https://lh5.googleusercontent.com/-b0-k99FZlyE/AAAAAAAAAAI/AAAAAAAAAAA/eu7opA4byxI/photo.jpg?sz=120\" alt=\"\"> <form class=\"form-signin\" ng-submit=\"app.login()\"> <input type=\"text\" class=\"form-control\" placeholder=\"Email\" ng-model=\"app.username\" required autofocus>\n<input type=\"password\" class=\"form-control\" placeholder=\"Password\" ng-model=\"app.password\" required>\n<button class=\"btn btn-lg btn-primary btn-block\" type=\"submit\"> Sign in</button> </form> </div> </div> </div> </div>";
	window.angular.module(["ng"]).run(["$templateCache",function(c){c.put("app.login.html", v1)}]);
	module.exports=v1;
...
/***/ function(module, exports) {
	...
	var v1="<section class=\"dashboard\"> <aside ng-include=\"'app.nav.html'\"> </aside> <div class=\"container-fluid main-container\"> <div class=\"col-md-2 sidebar\"> <div class=\"row\">  <div class=\"absolute-wrapper\"> </div>  <div class=\"side-menu\"> <nav class=\"navbar navbar-default\" role=\"navigation\">  <div class=\"side-menu-container\"> <ul class=\"nav navbar-nav\"> <li ng-repeat=\"item in app.navItems track by $index\"> <a ng-click=\"app.navigate(item.url)\"><span class=\"{{::item.class}}\"></span>{{::item.title}}</a> </li> </ul> </div> </nav> </div> </div> </div> <div class=\"col-md-10 content\"> <ng-view></ng-view> </div> <footer class=\"pull-left footer\"> <p class=\"col-md-12\"> <hr class=\"divider\"> Copyright &COPY; 2015 Jaganathan B </p> </footer> </div> </section>";
	window.angular.module(["ng"]).run(["$templateCache",function(c){c.put("app.dashboard.html", v1)}]);
	module.exports=v1;
...
/***/ function(module, exports) {
	...
	var v1="<nav class=\"navbar navbar-default navbar-static-top\"> <div class=\"container-fluid\"> <div class=\"navbar-header\"> <a class=\"navbar-brand\" href=\"#\"> Administrator </a> </div>  <div class=\"collapse navbar-collapse\" id=\"bs-example-navbar-collapse-1\"> </div> </div> </nav>";
	window.angular.module(["ng"]).run(["$templateCache",function(c){c.put("app.nav.html", v1)}]);
	module.exports=v1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../css-loader/index.js!./../../../autoprefixer-loader/index.js!./bootstrap.min.css", function() {
				var newContent = require("!!./../../../css-loader/index.js!./../../../autoprefixer-loader/index.js!./bootstrap.min.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
